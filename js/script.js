...
class Particle {
	...
	constructor() {
		...
		this.pos = new Vector2D(Math.floor(Math.random() * (innerWidth - this.radius - this.radius) + this.radius), Math.floor(Math.random() * (innerHeight - this.radius - this.radius) + this.radius));
